...
function(add_mqt_debugger_binding target_name)
  # parse the arguments
  ...
  if(ARG_MODULE_NAME)
    ...
    target_compile_definitions(${target_name} PRIVATE MQT_DEBUGGER_MODULE_NAME=${ARG_MODULE_NAME})
  else()
    # use the target name as the module name
    target_compile_definitions(${target_name} PRIVATE MQT_DEBUGGER_MODULE_NAME=${target_name})
  endif()
  ...
  install(
    ...
    COMPONENT ${MQT_DEBUGGER_TARGET_NAME}_Python)
endfunction()
